...
void heap_sort(int *array, size_t size)
{
	int i;
	/**
	 * Start from bottom and right internal mode and heapify all
	...
	/**
	* Repeat folowing steps while heap size is greater than 1.
	...
	*/
	for (i = (size - 1); i > 0; --i)
	{
		...
		*it wth the last item of the heap followed by reducing the
		*size of heap by 1.
		*/
